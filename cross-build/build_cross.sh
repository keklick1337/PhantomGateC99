...
gcc -std=c99 -static -Wall -Wextra -o "$BUILD_ROOT/x86_64/phantomgate" /src/*.c -pthread
...
arm-linux-gnueabihf-gcc -std=c99 -static -Wall -Wextra -o "$BUILD_ROOT/armv7/phantomgate" /src/*.c -pthread
...
aarch64-linux-gnu-gcc -std=c99 -static -Wall -Wextra -o "$BUILD_ROOT/aarch64/phantomgate" /src/*.c -pthread
...
mips-linux-gnu-gcc -std=c99 -static -Wall -Wextra -o "$BUILD_ROOT/mips/phantomgate" /src/*.c -pthread
...
riscv64-linux-gnu-gcc -std=c99 -static -Wall -Wextra -o "$BUILD_ROOT/riscv64/phantomgate" /src/*.c -pthread
